...
test.describe('Cart Feature',() =>{
    ...
    test('I want to return to the inventory page after clicking the "continue shopping" button.', async ({ page }) => {
        const cart = new cartPage(page);
...
test.describe('Checkout Order', () => {
    ...
    test('I want to checkout empty order', async ({ page }) => {
    ...
    test('I want to checkout with invalid input Postal Code', async ({ page }) => {
    ...
    test('II want to return to the cart page after clicking the "cancel" button.', async ({ page }) => {
    ...
    test('I want to cancel order and return to the inventory page', async ({ page }) =>{
        const checkout = new checkoutPage(page);
